<template>
  ...
  <div :key="message?.url">
    <!-- Main message -->
    <ChatMessage v-if="message" :message="message" :chatContext="getChatContext" :showMessageText="true" />

    <!-- reply -->
    <ChatMessage v-if="reply" :message="reply" :mainItemId="getMessageId" :chatContext="getChatContext" />

    <!-- Chat feed of replies -->
    <ChatFeed v-if="!isReply" :chatContext="getChatContext" :mainItemId="getMessageId" :showTopicModal="false" />
